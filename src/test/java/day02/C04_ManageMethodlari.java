...
public class C04_ManageMethodlari {
    public static void main(String[] args) {
        ...
        Bir sayfa acilirken, ilk basta sayfanin icerisinde bulunan elementlere gore bir yukleme
        suresine ihtiyac vardir veya bir webelementin kullanilabilmesi icin zamana ihtiyac olabilir.
